...
const SEP = "\x1e"; // 1-byte Record Separator for minimal payload size

/**
 * Compact client-side state packer:
...
/**
 * Unpacks the compact `#z=` payload back into a ShareState object
 */
...
/**
 * Resolves short links generated by your self-hosted `/api/resolve` endpoint
 */
